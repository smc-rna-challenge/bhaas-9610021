SMC-RNA Challenge Entry: bhaas-9610021
========================================================
...
```bash
# Clone this repo
git clone https://github.com/smc-rna-challenge/bhaas-9610021
cd bhaas-9610021
...
- [quay.io/smc-rna-challenge/bhaas-9610021-star:1.0.0](https://quay.io/smc-rna-challenge/bhaas-9610021-star:1.0.0)

- [quay.io/smc-rna-challenge/bhaas-9610021-fusionpipe:1.0.0](https://quay.io/smc-rna-challenge/bhaas-9610021-fusionpipe:1.0.0)
...
filters out fusions between paralogs
...
Duplicate reads, The presence of few reads spanning splice junctions, The presence of many multiply-mapped reads -- i.e. those reads having more than one match in the reference
...
[data]: https://www.synapse.org/#!Synapse:syn9878906
